# MIP0: Propuesta para la mejora del protocolo Maker

## Preamble

```
MIP#: 0
Title: Propuesta para la mejora del protocolo Maker
...
## Sentence Summary
MIP0 define el sistema de *Propuestas de mejora del Protocolo Maker* que todos los siguientes MIPs utilizaran.
...
*Define los conceptos básicos del sistema MIP.*  

**MIP0c2: Core Principles**  
*Establece los principios que todos los MIP deben seguir.*  

**MIP0c3: The MIP Lifecycle**  
*Define las etapas formales del ciclo de vida de los MIP desde la concepción hasta la aprobación, el rechazo o el aplazamiento.*  
